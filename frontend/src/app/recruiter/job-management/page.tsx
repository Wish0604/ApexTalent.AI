            ...
            <div className="glass-panel p-6 rounded-3xl max-w-lg w-full space-y-4 border border-white/20 animate-in fade-in">
              ...
              <form onSubmit={handleCreateJob} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <textarea value={description} onChange={e => setDescription(e.target.value)} required rows={3} placeholder="Describe responsibilities and requirements..." className="field-input w-full mt-1 resize-none" />
                </div>
