      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-white flex items-center gap-2">
                <Calendar className="w-6 h-6 text-violet-400" /> Community Events & Webinars Studio
              </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="glass-panel p-5 rounded-2xl border border-white/10 space-y-1">
            ...
            <p className="text-[10px] text-violet-400">Community Scheduled</p>
          </div>
          <div className="glass-panel p-5 rounded-2xl border border-white/10 space-y-1">
        ...
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {events.map((evt) => (
              <div key={evt.id} className="glass-panel p-6 rounded-2xl border border-white/10 space-y-4 hover:border-violet-500/40 transition">
                <div className="flex items-start justify-between">
                  <div>
                    <span className="badge badge-violet text-[10px] mb-1 inline-block font-mono">{evt.date}</span>
          ...
          <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div className="glass-panel p-6 rounded-3xl max-w-lg w-full space-y-4 border border-white/20 animate-in fade-in">
              <h2 className="text-lg font-black text-white flex items-center gap-2">
                <Plus className="w-5 h-5 text-violet-400" /> Create Community Event
              </h2>
              ...
              <form onSubmit={handleCreateEvent} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <textarea value={description} onChange={e => setDescription(e.target.value)} required rows={3} placeholder="Event agenda and speaker highlights..." className="field-input w-full mt-1 resize-none" />
                </div>
